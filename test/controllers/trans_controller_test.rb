...
class TransControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tran" do
    assert_difference('Tran.count') do
      post trans_url, params: { tran: { account_id: @tran.account_id, amount: @tran.amount, balance: @tran.balance, credit: @tran.credit, user_id: @tran.user_id } }
    end
  ...
  test "should update tran" do
    patch tran_url(@tran), params: { tran: { account_id: @tran.account_id, amount: @tran.amount, balance: @tran.balance, credit: @tran.credit, user_id: @tran.user_id } }
